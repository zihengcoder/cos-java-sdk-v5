...
public class COSObjectSummary implements Serializable {
     ...
     *
     * @param bucketName The name of the Qcloud COS bucket in which this object is
     *         stored.
     ...
     *
     * @param key The key under which this object is stored in Qcloud COS.
     ...
     * was last modified.
     *
     * @param lastModified The date when, according to Qcloud COS, this object
     *         was last modified.
     ...
     *
     * @param storageClass The storage class used by Qcloud COS for this object.
