...
public class CompleteMultipartUploadRequest extends CosServiceRequest implements Serializable {
     ...
     * @param partETags The list of part numbers and ETags to use when completing the
     *         multipart upload.
     */
     ...
     * from part uploads.
     *
     * @param uploadPartResults The list of results from the individual part uploads in the
     ...
     * from part uploads.
     *
     * @param uploadPartResultsCollection The list of results from the individual part uploads in the
     *         multipart upload to complete.
     * @return This updated CompleteMultipartUploadRequest object.
     */
