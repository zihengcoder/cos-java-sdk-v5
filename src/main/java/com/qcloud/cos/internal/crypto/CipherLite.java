...
class CipherLite {
     ...
     *
     * @param startingBytePos the starting byte position of the plaintext. Must be a
     ...
     * @throws BadTagException if this cipher is decrypting in an AEAD mode (such as
